              ...
              <div className="mt-4 flex w-[320px] sm:w-[480px] flex-col items-center gap-4 ">
                <div className="flex justify-center items-center">
                  <img
                    ...
                    className="w-10 h-10"
                  />
                  <h1 className="sm:text-[25px] capitalize">{cityName}</h1>
                </div>
                <div className="space-x-3 sm:space-x-8">
                  <input
                    type="search"
                    className="bg-third rounded-lg p-2 pl-3 z-20 capitalize text-black focus:outline-none sm:w-[300px]"
                ...
                {data === "" || data === null ? (
                  ...
                  rounded-[20%] shadow-2xl z-50 hover:scale-110 duration-300 ease-in-out sm:h-[100px] sm:w-[100px] "
                        />
                      </div>
                    </div>
                  </>
